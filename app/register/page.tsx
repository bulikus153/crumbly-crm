...
import { Bot, Eye, EyeOff, Sparkles, Shield, Zap, CheckCircle } from 'lucide-react'
...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-purple-50/30 to-pink-50/20 dark:from-slate-950 dark:via-purple-950/50 dark:to-slate-900 flex items-center justify-center p-4 relative overflow-hidden">
      ...
      <Card className="w-full max-w-lg backdrop-blur-xl bg-white/10 dark:bg-black/10 border border-white/20 dark:border-white/10 shadow-2xl shadow-purple-500/10 hover:shadow-purple-500/20 transition-all duration-500 rounded-3xl">
        <CardHeader className="text-center space-y-6 pb-8">
          ...
          <div className="grid grid-cols-3 gap-4 pt-4">
            <div className="text-center space-y-2">
              <div className="w-10 h-10 bg-gradient-to-br from-green-500 to-emerald-500 rounded-xl flex items-center justify-center mx-auto">
                <CheckCircle className="w-5 h-5 text-white" />
              </div>
              <p className="text-xs text-gray-600 dark:text-white/70">14-day free trial</p>
            </div>
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-600 dark:text-white/70">AI-powered insights</p>
            </div>
            <div className="text-center space-y-2">
              ...
              <p className="text-xs text-gray-600 dark:text-white/70">Enterprise security</p>
            </div>
          </div>
        </CardHeader>
        ...
        <CardContent className="space-y-6 px-8 pb-8">
          ...
          <div className="relative">
            ...
            <div className="relative flex justify-center text-sm uppercase">
              <span className="bg-transparent px-4 text-gray-600 dark:text-white/70 font-medium">Or create with email</span>
            </div>
          </div>
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="space-y-2">
                ...
                <Input
                  ...
                  className="bg-white/10 dark:bg-black/10 border-2 border-white/20 dark:border-white/10 text-gray-900 dark:text-white placeholder:text-gray-600 dark:placeholder:text-white/50 rounded-2xl py-3 px-4 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
                />
              </div>
              <div className="space-y-2">
            ...
            <div className="space-y-2">
              ...
              <div className="relative">
                <Input
                  ...
                  className="bg-white/10 dark:bg-black/10 border-2 border-white/20 dark:border-white/10 text-gray-900 dark:text-white placeholder:text-gray-600 dark:placeholder:text-white/50 rounded-2xl py-3 px-4 pr-12 focus:border-purple-500 focus:ring-2 focus:ring-purple-500/20 transition-all duration-300"
                />
                <Button
                  type="button"
                  variant="ghost"
          ...
          <div className="flex items-start space-x-3 pt-2">
            <Checkbox 
              ...
              className="mt-1 border-2 border-white/20 dark:border-white/10 data-[state=checked]:bg-gradient-to-r data-[state=checked]:from-purple-500 data-[state=checked]:to-pink-500 data-[state=checked]:border-purple-500"
            />
            <Label htmlFor="terms" className="text-sm text-gray-600 dark:text-white/70 leading-relaxed">
              I agree to the{" "}
              <Link href="/terms" className="text-purple-500 hover:text-purple-400 transition-colors duration-300 font-medium underline underline-offset-2">
                Terms of Service
              </Link>{" "}
              and{" "}
              <Link href="/privacy" className="text-purple-500 hover:text-purple-400 transition-colors duration-300 font-medium underline underline-offset-2">
                Privacy Policy
              </Link>
            </Label>
          </div>
          ...
          <Link href="/dashboard">
            <Button 
              className="w-full bg-gradient-to-r from-purple-500 via-pink-500 to-purple-600 hover:from-purple-600 hover:via-pink-600 hover:to-purple-700 shadow-xl shadow-purple-500/25 hover:shadow-purple-500/40 transition-all duration-300 hover:scale-105 py-6 rounded-2xl text-lg font-medium group disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <div className="text-center text-gray-600 dark:text-white/70 pt-4">
            Already have an account?{" "}
            <Link href="/login" className="text-purple-500 hover:text-purple-400 transition-colors duration-300 font-medium">
              Sign in
            </Link>
          </div>
        </CardContent>
